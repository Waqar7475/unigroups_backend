"""
UniGroups Backend — Production Settings
"""
...
SECRET_KEY    = os.environ.get('SECRET_KEY', 'django-insecure-change-me-xyz789abc123')
...
# Disable redirect from /api/auth/register to /api/auth/register/
# This causes 405 on POST requests
APPEND_SLASH = False
